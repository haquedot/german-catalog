    ...
    return (
        <>
            <footer className="bg-[#1A8D91] rounded-t-[30px]">
                <div className="block md:w-10/12 mx-auto md:py-[70px]">
                    <div className="flex flex-col md:flex-row justify-between mx-4 py-12">
                        ...
                        <div className="w-max flex flex-col space-y-2 text-white">
